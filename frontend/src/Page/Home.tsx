      ...
      <div className="search-section bg-black p-10 text-center mt-20">
        ...
        <div className="w-full">
          ...
          <form className="search bg-[#acacac] p-9 mx-auto rounded-2xl" onSubmit={handleSearchSubmit}>
            <input type="text" name="search" className="w-[600px] h-10 px-2 text-[20px] border-3 border-transparent focus:border-[#ccb552] focus:outline-none rounded-md bg-white" />
            <button type="submit" className="ml-5 w-44 h-10 border-none rounded text-[20px] font-bold bg-gray-200 hover:bg-black hover:text-[#ccb552] hover:cursor-pointer">
